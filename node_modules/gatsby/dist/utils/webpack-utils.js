...
module.exports = async ({
  ...
  {
    let dependencies = (_ref2 = {
      modulesThatUseGatsby: []
    }) => {
      let {
        modulesThatUseGatsby
      } = _ref2,
          options = (0, _objectWithoutPropertiesLoose2.default)(_ref2, ["modulesThatUseGatsby"]);
      const jsOptions = {
        babelrc: false,
        configFile: false,
        compact: false,
    ...
    const css = (_ref3 = {}) => {
      let {
        browsers
          ...
          options = (0, _objectWithoutPropertiesLoose2.default)(_ref3, ["browsers"]);
  ...
  plugins.minifyJs = (_ref4 = {}) => {
    let {
      terserOptions
    } = _ref4,
        options = (0, _objectWithoutPropertiesLoose2.default)(_ref4, ["terserOptions"]);
